...
int main(int argc, char* argv[]) {
	...
	light1.isOn = false; light1.attenuationIsTurnedOn = false;
	cout << light1.illuminate(interceptPt, n, mat1, viewerPos, true) << endl;
