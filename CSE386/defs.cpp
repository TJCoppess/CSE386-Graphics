...
/**
 * @fn	dvec3 Frame::globalCoordToFrameCoords(const dvec3 &pt) const
...
/**
* @fn	dvec3 Frame::frameCoordsToGlobalCoords(const dvec3 &pt) const
...
/**
 * @fn	dvec3 Frame::globalVectorToFrameVector(const dvec3 &V) const
...
/**
 * @fn	dvec3 Frame::frameVectorToWorldVector(const dvec3 &V) const
...
/**
 * @fn	Frame Frame::createOrthoNormalBasis(const dvec3& pos, const dvec3& w)
