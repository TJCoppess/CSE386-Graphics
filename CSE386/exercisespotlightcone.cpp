...
int main(int argc, char* argv[]) {
	...
	cout << endl << "Spotlight::illuminate" << endl;
	{
		...
		cout << spot.illuminate(dvec3(0.0, 0.0, 0.0), dvec3(0.0, 1.0, 0.0), tin, pCamera.getFrame().origin, false) << endl;
		cout << spot.illuminate(dvec3(0.0, 0.0, 0.0), dvec3(0.0, 1.0, 0.0), tin, pCamera.getFrame().origin, true) << endl;
		cout << spot.illuminate(dvec3(1.0, 0.0, 0.0), dvec3(0.0, 1.0, 0.0), tin, pCamera.getFrame().origin, false) << endl;
		cout << spot.illuminate(dvec3(1.0, 0.0, 0.0), dvec3(0.0, 1.0, 0.0), tin, pCamera.getFrame().origin, true) << endl;
	}
